...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12 sm:space-y-16 font-secondary text-[#172017]">
      ...
      <section className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-[#DDE8DE] bg-gradient-to-br from-[#F3FAF4] via-[#F8FCF8] to-[#F0FDF4] p-6 sm:p-12 lg:p-16">
        <div className="max-w-3xl space-y-4 sm:space-y-6">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#DCFCE7] text-[#166534] text-xs font-bold font-primary tracking-wider uppercase">
            <Sparkles size={13} className="text-[#16A34A]" /> Notre Vision
          </span>
          <h1
            className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#172017] tracking-tight leading-[1.15] font-primary"
            style={{ fontFamily: "'Manrope', sans-serif" }}
          >
            L&apos;exigence de l&apos;essentiel.
          </h1>
          <p className="text-base sm:text-lg text-[#647064] leading-relaxed">
            Chez <strong className="text-[#172017] font-semibold">DSK-Shop</strong>, nous croyons qu&apos;un espace de travail et des équipements du quotidien doivent allier pureté visuelle, acoustique fidèle et longévité mécanique.
          </p>
          <div className="pt-2">
            <button
              onClick={handleExploreShop}
              className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#16A34A] hover:bg-[#166534] text-white rounded-xl text-sm font-bold font-primary transition-colors shadow-xs cursor-pointer"
            >
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        <div className="lg:col-span-6 space-y-5">
          ...
          <p className="text-sm sm:text-base text-[#647064] leading-relaxed">
            Plutôt que d&apos;accumuler des milliers de références superflues, notre équipe teste, calibre et sélectionne uniquement les outils qui apportent un réel gain de confort, de silence et de performance.
          </p>
          <ul className="space-y-3 pt-2 text-sm text-[#172017]">
            <li className="flex items-start gap-2.5">
              <CheckCircle2 size={18} className="text-[#16A34A] mt-0.5 flex-shrink-0" />
              <span>Contrôle qualité systématique avant chaque expédition</span>
            </li>
            <li className="flex items-start gap-2.5">
              <CheckCircle2 size={18} className="text-[#16A34A] mt-0.5 flex-shrink-0" />
              <span>Conception ergonomique validée pour les longues sessions</span>
            </li>
            <li className="flex items-start gap-2.5">
              <CheckCircle2 size={18} className="text-[#16A34A] mt-0.5 flex-shrink-0" />
              <span>Service après-vente dédié et assistance en direct</span>
            </li>
          </ul>
        </div>
      ...
      <section className="space-y-6">
        <div className="text-center max-w-xl mx-auto">
          ...
          <p className="text-sm text-[#647064] mt-1.5">
            Une expérience d&apos;achat transparente, fiable et respectueuse.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {commitments.map((c, idx) => {
            ...
            return (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-[#FFFFFF] border border-[#DDE8DE] shadow-2xs hover:border-[#16A34A] transition-all space-y-3"
              >
                ...
                <div>
                  ...
                  <h3
                    className="text-base font-bold text-[#172017] mt-0.5 font-primary"
                    style={{ fontFamily: "'Manrope', sans-serif" }}
                  >
                    {c.title}
                  </h3>
